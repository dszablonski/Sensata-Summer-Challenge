...
func Change_colour():
	randomize()
	GlobalDate.CautionLevel6=int(rand_range(0,5))
	if GlobalDate.CautionLevel6==0:
		set_button_icon(Icon_grey)
	elif GlobalDate.CautionLevel6==1:
		set_button_icon(Icon_Green)
	elif GlobalDate.CautionLevel6==2:
		set_button_icon(Icon_Yellow)
	elif GlobalDate.CautionLevel6==3:
		set_button_icon(Icon_Orange)
	elif GlobalDate.CautionLevel6==4:
		set_button_icon(Icon_Red)
	elif GlobalDate.CautionLevel6==5:
